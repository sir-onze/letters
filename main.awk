...
print(html_link_open,"index.html",close_tag,"(b) Criar um index HTML com todos os anos, em que cada ano deve ligar a outra p ́agina HTML onde conste, para cada carta desse ano, o tıtulo da carta e o seu resumo.",html_link_close) > "html/indice.html";
